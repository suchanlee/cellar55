    ...
    def get_wine(self):
        ...
        try:
            return Wine(
                ...
                service_temperature = tech_notes.get('Service Temperature', ''),
                glassware = tech_notes.get('Glassware', ''),
                drinking_window = tech_notes.get('Drinking Window', ''),
                decanting = tech_notes.get('Decanting', ''),
